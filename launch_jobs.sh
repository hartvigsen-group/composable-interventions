...
params=(
    ...
    'edit=True compress=True compress_first=True method=prune prune_method=wanda sparsity_ratio=0.25 tag=MEMIT-rightarrow-Wanda$_\{25%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=wanda sparsity_ratio=0.35 tag=MEMIT-rightarrow-Wanda$_\{35%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=wanda sparsity_ratio=0.45 tag=MEMIT-rightarrow-Wanda$_\{45%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=wanda sparsity_ratio=0.55 tag=MEMIT-rightarrow-Wanda$_\{55%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=wanda sparsity_ratio=0.65 tag=MEMIT-rightarrow-Wanda$_\{65%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=wanda sparsity_ratio=0.75 tag=MEMIT-rightarrow-Wanda$_\{75%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=wanda sparsity_ratio=0.85 tag=MEMIT-rightarrow-Wanda$_\{85%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=sparsegpt sparsity_ratio=0.25 tag=MEMIT-rightarrow-SparseGPT$_\{25%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=sparsegpt sparsity_ratio=0.35 tag=MEMIT-rightarrow-SparseGPT$_\{35%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=sparsegpt sparsity_ratio=0.45 tag=MEMIT-rightarrow-SparseGPT$_\{45%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=sparsegpt sparsity_ratio=0.55 tag=MEMIT-rightarrow-SparseGPT$_\{55%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=sparsegpt sparsity_ratio=0.65 tag=MEMIT-rightarrow-SparseGPT$_\{65%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=sparsegpt sparsity_ratio=0.75 tag=MEMIT-rightarrow-SparseGPT$_\{75%\}$'
    'edit=True compress=True compress_first=True method=prune prune_method=sparsegpt sparsity_ratio=0.85 tag=MEMIT-rightarrow-SparseGPT$_\{85%\}$'
)
