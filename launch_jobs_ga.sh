...
# # zsre
sbatch run_exp10x.sh save_ckpt=False wandb=online edit=lora edit_dataset=zsre compression=none unlearn=ga interventions=[unlearn,edit] tag="ga-lora"
sbatch run_exp10x.sh save_ckpt=False wandb=online edit=ft edit_dataset=zsre compression=none unlearn=ga interventions=[unlearn,edit] tag="ga-ft"
sbatch run_exp10x.sh save_ckpt=False wandb=online edit=memit edit_dataset=zsre compression=none unlearn=ga interventions=[unlearn,edit] tag="ga-memit"
...
# # zsre
sbatch run_exp10x.sh save_ckpt=False wandb=online edit=lora edit_dataset=zsre compression=none unlearn=ga interventions=[edit,unlearn] tag="lora-ga"
sbatch run_exp10x.sh save_ckpt=False wandb=online edit=ft edit_dataset=zsre compression=none unlearn=ga interventions=[edit,unlearn] tag="ft-ga"
sbatch run_exp10x.sh save_ckpt=False wandb=online edit=memit edit_dataset=zsre compression=none unlearn=ga interventions=[edit,unlearn] tag="memit-ga"
